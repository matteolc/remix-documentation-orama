...
export function Header() {
  ...
  return (
    <header
      className={clsx(
        "sticky top-0 z-30 flex flex-none flex-wrap items-center justify-between bg-white px-4 py-5 shadow-md shadow-slate-900/5 transition duration-500 sm:px-6 lg:px-8 dark:shadow-none",
